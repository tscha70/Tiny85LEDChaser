...
void loop()
{
  ...
  for (byte i = 0; i <= 15; i++)
  {
    ...
    DisplayLeds(PATTERN << i, REPETITIONS + i / 2);
  }

  // Just a little extra break, before the raindrop falls off completely.
  DisplayLeds(PATTERN << 15, 23);
...
void DisplayLeds(int pattern, int repetitions)
{
